...
DMinstrel.Commands = {};
DMinstrel.Commands[1] = {"Что-то ещё -1", ""};
DMinstrel.Commands[2] = {"Что-то ещё 0", ""};
...
DMinstrel.Commands[24] = {"Что-то ещё 20", ""};
...
DMinstrel.NPC[23] = {"Что-то ещё 11", ""};
DMinstrel.NPC[24] = {"Что-то ещё 12", ""};

DMinstrel.GObject = {};
DMinstrel.GObject[1] = {"Огонь", ".min gob add 723227"};
DMinstrel.GObject[2] = {"Кровь", ".min gob add 735194"};
DMinstrel.GObject[3] = {"Что-то ещё -1", ""};
DMinstrel.GObject[4] = {"Что-то ещё 0", ""};
DMinstrel.GObject[5] = {"Что-то ещё 1", ""};
